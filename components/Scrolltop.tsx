...
const Scrolltop = ({articleRef}:any) => {
 ...
 const handleScroll= (e:any) => {
  setScrollBottom(!scrollBottom);
    ...
    window.scrollTo({top: scrollBottom? 0 : document.body.offsetHeight, left: 0, behavior: 'smooth'});
...
console.log(articleRef.current,"articleRef");
  ...
  return (
    <>
        <a id="scroll-top" onClick={handleScroll} className="scroll-top"  title="Top" role="button"><i className="w-icon-angle-up"></i> 
