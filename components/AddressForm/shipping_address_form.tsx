...
import { storeCustomerAddressApi, store_address } from "../../store/slices/customer_addresses_slice/store_address_slice";
...
const FormShippingAddress = ({ show, toHide, address_type}: any) => {

    const dispatch = useDispatch()

    // const storeAddresses = useSelector(store_address);
        ...
        <>
            <Modal show={show} onHide={toHide}>
                ...
                onSubmit={(values: any, action: any) => {
                  ...
                  dispatch(
                    storeCustomerAddressApi({ ...values })
                  );
                  setTimeout(() => {
                    dispatch(CustomerShippingAddressAPi());
                    dispatch(CustomerBillingAddressAPi())
