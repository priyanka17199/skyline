                 ...
                 {related_product.map((products:any,i:any)=>(
                        <div className="swiper-slide product-wrap" key={i}> 
                            <div className="product text-center">
                                ...
                                <Link href="#">
                                    <a href="#">
                                        <Image src={products.image_url} alt="Product" width={products.width} height={products.height} />
                                    </a>
                                    </Link>
                                ...
                                <div className="product-details">
                                    <h4 className="product-name"><Link href="#"><a>{products.prod_name}</a></Link></h4>
                                    <div className="product-price">
                                        <ins className="new-price">$60.54</ins><del className="old-price">$65.25</del>
                                    </div>
                                </div>
                            </div>
                        </div>))} 
